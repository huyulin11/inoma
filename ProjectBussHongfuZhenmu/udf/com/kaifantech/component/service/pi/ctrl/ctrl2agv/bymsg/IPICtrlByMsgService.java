...
public interface IPICtrlByMsgService {
	...
	public default PiCommandMsg dangerous(HongfuAgvMsgBean msgOne) {
	...
	public default PiCommandMsg dangerous(HongfuAgvMsgBean msgOne, HongfuAgvMsgBean msgAnother) {
		PiCommandMsg command = new PiCommandMsg();
		command.setDistanceStatus(DistanceStatus.DANGEROUS);
		if (!AppTool.isNull(msgOne)) {
			command.getDangerMsgs().add(msgOne);
	...
	public default PiCommandMsg safe(HongfuAgvMsgBean msgOne, HongfuAgvMsgBean msgAnother) {
		PiCommandMsg command = new PiCommandMsg();
	...
	public default PiCommandMsg warning(HongfuAgvMsgBean msgOne, HongfuAgvMsgBean msgAnother) {
		PiCommandMsg command = new PiCommandMsg();
