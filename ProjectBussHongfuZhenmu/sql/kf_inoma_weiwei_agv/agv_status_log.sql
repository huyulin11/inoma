...
-- Dumping structure for table kf_inoma_weiwei_agv.agv_status_log
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='启停任务执行表';

-- Dumping data for table kf_inoma_weiwei_agv.agv_status_log: ~0 rows (大约)
