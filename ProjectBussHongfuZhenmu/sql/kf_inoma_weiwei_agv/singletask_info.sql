...
-- Dumping data for table kf_inoma_weiwei_agv.singletask_info: ~5 rows (approximately)
...
INSERT INTO `singletask_info` (`environment`, `id`, `taskName`, `taskText`, `taskType`, `allocOpType`, `allocid`, `environmentId`, `agvId`, `lapId`, `isSendToAGV`, `delflag`, `orderby`, `createtime`) VALUES
	(1, 1, '1-A-1-1-1-114.xml', '1-A-1-1-1-114任务', '-1', 'RECEIPT', 1, 0, 1, 1, 1, 0, 0, '2018-05-09 16:08:24'),
	(1, 2, '2-A-1-1-1-114.xml', '2-A-1-1-1-114任务', '-1', 'RECEIPT', 1, 0, 2, 2, 1, 0, 0, '2018-05-09 16:08:24'),
	(1, 3, '3-A-1-1-1-114.xml', '3-A-1-1-1-114任务', '-1', 'RECEIPT', 1, 0, 3, 3, 1, 0, 0, '2018-05-09 16:08:24'),
	(1, 5, '1-A-1-2-1-114.xml', '1-A-1-2-1-114任务', '-1', 'RECEIPT', 2, 0, 1, 1, 1, 0, 0, '2018-05-09 16:08:24'),
	(1, 6, '2-A-1-2-1-114.xml', '2-A-1-2-1-114任务', '-1', 'RECEIPT', 2, 0, 2, 2, 1, 0, 0, '2018-05-09 16:08:24');
