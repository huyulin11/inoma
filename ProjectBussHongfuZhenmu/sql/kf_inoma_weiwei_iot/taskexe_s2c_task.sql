...
-- Dumping structure for table kf_inoma_weiwei_iot.taskexe_s2c_task
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='运输任务执行表';

-- Dumping data for table kf_inoma_weiwei_iot.taskexe_s2c_task: ~0 rows (approximately)
