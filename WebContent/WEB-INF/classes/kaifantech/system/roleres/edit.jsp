...
<script type="text/javascript" src="${ctx_js}/system/roleres/edit.js"></script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
	float: left;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/roleres/editEntity.shtml">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control checkRole"
							placeholder="请输入角色名" name="roleFormMap.rolename" id="rolename" value="${role.name}"/>
					</div>
				</div>
