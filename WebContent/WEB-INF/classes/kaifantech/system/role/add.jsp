...
<html>
<head>
<%@include file="/WEB-INF/jsp/common/commonCss.jspf"%>
<%@include file="/WEB-INF/jsp/common/commonJs.jspf"%>
<script type="text/javascript" src="${ctx_js}/system/role/add.js">
					...
					<div class="btn-group m-r">
						...
						<ul class="dropdown-menu dropdown-select">
							<li class=""><a href="#"><input type="radio"
									name="roleFormMap.state" value="0">是</a></li>
							<li class="active"><a href="#"><input type="radio"
									name="roleFormMap.state" value="1" checked>否</a></li>
						</ul>
					</div>
				</div>
			</div>
